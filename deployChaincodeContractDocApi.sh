...
presetup(){
    ...
    pushd ./artifacts/src/github.com/fabdoc_contract_api/go
...
chaincodeInvoke(){
    ...
    #     -c '{"function": "CreateCar","Args":["Car98", "Wol", "Q7", "Red", "Abakar"]}'
   ...
   # Create Car
    peer chaincode invoke -o localhost:7050 \
        ...
        --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
        -c '{"function": "CreateDoc","Args":["C/01/N007", "Abakar", "Pro", "2000-01-02", "Garoua", "Masculin", "Camerounais", "1988-02-12", "Bouba"]}'
